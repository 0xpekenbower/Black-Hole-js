const auth = {
  ...
  forgotPassword: {
    ...
    otpSubtitle: "Entrez le code à 6 caractères envoyé à votre email",
    otpLabel: "Code de vérification",
    verifyButton: "Vérifier le code",
    backButton: "Retour à l'email",
    backToEmail: "Retour à l'email",
    resendCode: "Vous n'avez pas reçu de code? Demander un nouveau",
    resendSuccess: "Nouveau code envoyé! Vérifiez votre email.",
